...
def model_optimized(n,symmetry=False,timeout=300,**kwargs):
    ...
    try:
        ...
        while time.time() < timeout_timestamp:
            ...
            if result_check==sat:
                ...
                if best_obj is None or current_obj<best_obj:
                    ...
                    # Print intermediate result (commented out for quiet mode)
        ...
        if result_check==sat:
            ...
            result["optimal"]=(end-start_timestamp)<timeout
            result["obj"]=result_objective
            
            # We extract the schedule
            schedule={
                "weeks":[],
                "home_counts":[0] *n,
